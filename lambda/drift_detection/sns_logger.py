...
class SNSLogHandler(logging.Handler):
    def __init__(self, topic, subject, profile=None, region=None):
...
class SNSlogger(object):
    def __init__(self, sns_topic_id, sns_topic_subject, profile=None, region=None):
    ...
    def _init_logging(self):
        ...
        sns = SNSLogHandler(self.sns_topic, self.sns_subject, self.profile, self.region)
